    ...
    <div class="dropdown">
        <button class="btn btn-secondary dropdown-toggle d-flex align-items-center justify-content-center" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="header_img d-flex align-items-center">
                <img src="<?= ($person->getImg() == "")? "https://i.imgur.com/hczKIze.jpg": "client/img/profiles/".$person->getImg().""?>" alt="User Image" id="userImage" class="rounded-circle me-2" style="width: 40px; height: 40px;">
            </div>
            <p class="user-name m-0 ms-2 text-center"><?= $person->getName()." ".$person->getLastName()." "?></p>
        </button>
    ...
    <nav class="nav">
        <div>
            ...
            <div class="nav_list">
                ...
                <a href="?pid=<?= base64_encode("client/pages/Users.php")?>" class="nav_link <?= ($route=="client/pages/Users.php")?"active":"" ?>">
