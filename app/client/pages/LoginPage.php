...
if (isset($_POST['sendButton'])) {
    ...
    $person = new Administrator(null, null, null, $correo, $clave);
    if ($person->autenticar()) {
        $_SESSION["id"] = $person->getIdPerson();
        $_SESSION["role"] = "A";
        header("Location: ?pid=" . base64_encode("client/pages/Home.php"));
    } else {
        $person = new Seller(null, null, null, $correo,  $clave);
        if ($person->autenticar()) {
            $_SESSION["id"] = $person->getIdPerson();
            $_SESSION["role"] = "S";
            header("Location: ?pid=" . base64_encode("client/pages/Home.php"));
            ...
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                ...
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        <form method="post" action="?pid=<?= base64_encode("client/pages/LoginPage.php")?>" class="needs-validation" novalidate="" autocomplete="on">
